...
nove 是一个面向 AI 时代的**智能数据仓库**。本白皮书系统性阐述 nove 在 **系统架构、AI 服务设计、工程治理与安全机制** 方面的整体技术方案，重点说明为何采用 **NestJS + FastAPI 的双后端架构**，以及如何通过 **数据平面 / 智能平面分离 + 人机统一权限**，支撑"组织数据成为 AI 可安全调用的资产"这一核心目标。
